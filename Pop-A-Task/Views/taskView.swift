...
////                                    AddTaskModalView(isTaskModal: $isTaskModal, categories: <#Binding<[String]>#>)
////                                }
////                                Button("Task Setting"){
////                                    isTaskSetting = true
...
//    @ObservedObject var userData = UserData()
//    @Binding var isLoggedIn: Bool
//    @State var categories = ["High", "Medium", "Low"]
//
//    var body: some View {
//        NavigationView {
//            ZStack {
...
//                                }
//                                .sheet(isPresented: $isTaskModal) {
//                                    AddTaskModalView(isTaskModal: $isTaskModal, categories: $categories)
//                                }
//
//                                Button("Task Setting") {
//                                    isTaskSetting = true
