...
struct TaskDetail: View {
    ...
    init(task: Task, taskViewModel: TaskViewModel, categoryViewModel: CategoryViewModel, statusViewModel: StatusViewModel, priorityViewModel: PriorityViewModel, groupViewModel: GroupViewModel)  {
        self.task = task
